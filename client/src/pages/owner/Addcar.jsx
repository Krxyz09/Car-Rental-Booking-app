  ...
  return (
    <div className="px-4 py-10 md:px-10 flex-1">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col w-full">
            ...
            <input
              ...
              className="mt-1 border border-borderColor rounded-md px-3 py-2 outline-none"
              required
            />
          </div>
          <div className="flex flex-col w-full">
        ...
        <button
          type="submit"
          className="bg-primary text-white cursor-pointer px-6 py-2 rounded-md mt-4 hover:bg-primary/90 flex items-center gap-50"
        >
